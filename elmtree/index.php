    ...
    <body>  
            ...
            <nav class="navbar navbar-dark bg-dark">
                ...
                <div class="col-3.5 ">
                    ...
                    <form class="form-inline my-2" action="category.php" method="post" enctype="multipart/form-data">
                        ...
                        <button class="btn btn-outline-dark text-light" type="submit" name="submit-category">Filter</button>
                    </form>
                </div>
                ...
                <?php
                    ...
                    if(isset($_SESSION['40247362_userID']) ){
                                
                        echo "
                        <a class='btn btn-outline-dark text-light' href='admin/logout.php' role='button'>Admin</a>
                                
                        <a class='btn btn-outline-dark text-light' href='admin/userhome.php' role='button'>Log out</a>";
                    } else {
                        echo "<div class='col-4.5 inline'>
