<?php
	...
	$addItem = "INSERT INTO item (itemName, itemImg, itemPrice, itemDescription, dateAdded, categoryID, userID) VALUES ('$itemfield', '$pic', '$pricefield','$descriptionfield', '$dateadded', '$categoryfield', '$userID')";
